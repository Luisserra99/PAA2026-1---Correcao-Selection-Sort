...
include bubblesort_make.mk.conf
...
bubblesort_make.mk.conf: _CoqProject
	rocq makefile -f _CoqProject -o bubblesort_make.mk

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code they may need
-include bubblesort_make.mk.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in bubblesort_make.mk.local once and for all.
...
# put in bubblesort_make.mk.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in bubblesort_make.mk.local
#
###############################################################################
...
#
# There rules can be extended in bubblesort_make.mk.local
...
# extension points and bubblesort_make.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in bubblesort_make.mk.local or include bubblesort_make.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in bubblesort_make.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create bubblesort_make.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include bubblesort_make.mk.local-late
