...
include selectionsort_make.mk.conf
...
selectionsort_make.mk.conf: _CoqProject
	rocq makefile -f _CoqProject -o selectionsort_make.mk

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code they may need
-include selectionsort_make.mk.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in selectionsort_make.mk.local once and for all.
...
# put in selectionsort_make.mk.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in selectionsort_make.mk.local
#
###############################################################################
...
VDFILE := .selectionsort_make.mk.d
...
#
# There rules can be extended in selectionsort_make.mk.local
...
# extension points and selectionsort_make.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in selectionsort_make.mk.local or include selectionsort_make.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in selectionsort_make.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create selectionsort_make.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include selectionsort_make.mk.local-late
